...
class TestIvniteVolunteersNoEvent(TestCase):
    ...
    def test_invite_new_single_with_personal_message(self):
        ...
        # asserting email vars values
        expected_list = ['<pre>Test msg</pre>', 'PERSONAL_MESSAGE', 'first_npf_admin_1', 'ADMIN_FIRSTNAME', 'last_npf_admin_1', 'ADMIN_LASTNAME', 'NPF_org_1', 'ORG_NAME']
        self._assert_merge_vars(session['merge_vars'], expected_list)
    ...
    def test_invite_new_bulk_with_personal_message(self):
        ...
        # asserting email vars values
        expected_list = ['<pre>Test msg 2</pre>', 'PERSONAL_MESSAGE', 'first_npf_admin_1', 'ADMIN_FIRSTNAME', 'last_npf_admin_1', 'ADMIN_LASTNAME', 'NPF_org_1', 'ORG_NAME']
        self._assert_merge_vars(session['merge_vars'], expected_list)
...
class TestIvniteVolunteersToEvent(TestCase):
    ...
    def test_invite_new_single_with_message(self):
        ...
        # asserting email vars values
        expected_list = ['<pre>Test msg</pre>', 'PERSONAL_MESSAGE', 'first_npf_admin_1', 'ADMIN_FIRSTNAME', 'last_npf_admin_1', 'ADMIN_LASTNAME', 'test_project_1', 'EVENT_TITLE', 'NPF_org_1', 'ORG_NAME', 'test_location_1', 'EVENT_LOCATION']
        self._assert_merge_vars(session['merge_vars'], expected_list)
    ...
    def test_invite_new_bulk_with_message(self):
        ...
        # asserting email vars values
        expected_list = ['<pre>Test msg 2</pre>', 'PERSONAL_MESSAGE', 'first_npf_admin_1', 'ADMIN_FIRSTNAME', 'last_npf_admin_1', 'ADMIN_LASTNAME', 'test_project_1', 'EVENT_TITLE', 'NPF_org_1', 'ORG_NAME', 'test_location_1', 'EVENT_LOCATION']
        self._assert_merge_vars(session['merge_vars'], expected_list)
    ...
    def test_invite_to_event_single_existing_nopass_with_message(self):
        ...
        # asserting email vars values
        expected_list = ['<pre>Test msg single existing</pre>', 'PERSONAL_MESSAGE', 'first_npf_admin_1', 'ADMIN_FIRSTNAME', 'last_npf_admin_1', 'ADMIN_LASTNAME', 'test_project_1', 'EVENT_TITLE', 'NPF_org_1', 'ORG_NAME', 'test_location_1', 'EVENT_LOCATION']
        self._assert_merge_vars(session['merge_vars'], expected_list)
    ...
    def test_invite_bulk_existing_with_personal_message(self):
        ...
        # asserting email vars values
        expected_list = ['<pre>Test msg bulk existing users</pre>', 'PERSONAL_MESSAGE', 'first_npf_admin_1', 'ADMIN_FIRSTNAME', 'last_npf_admin_1', 'ADMIN_LASTNAME', 'test_project_1', 'EVENT_TITLE', 'NPF_org_1', 'ORG_NAME', 'test_location_1', 'EVENT_LOCATION']
        self._assert_merge_vars(session['merge_vars'], expected_list)
