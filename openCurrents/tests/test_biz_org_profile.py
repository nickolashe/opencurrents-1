...
class TestOfferDelete(SetupAll):
    ...
    def test_remove_offer(self):
        ...
        self.assertRedirects(response, "/biz-admin/Offer%20'Offer%20for%2040%25%20on%20Test%20Item1%20by%20BIZ_org_1'%20has%20been%20removed//", status_code=302, target_status_code=200)
