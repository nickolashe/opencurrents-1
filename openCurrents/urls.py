...
urlpatterns = [
    ...
    url(r'^admin-profile/(?P<num_events>\d+)/$', views.AdminProfileView.as_view(), name='admin-profile'),
    url(r'^admin-profile/(?P<num_events>\d+)/(?P<num_vols>\d+)/$', views.AdminProfileView.as_view(), name='admin-profile'),
    ...
    url(r'^invite-volunteers/(?P<num_events>\d+)/$', views.InviteVolunteersView.as_view(), name='invite-volunteers'),
